...
var flysnd, selectsnd, snortsnd;

function preload() {
    getBackgroundImg();
    bgimg = loadImage(bg);

    flysnd = loadSound("sounds/sounds_bird_flying.mp3");
    selectsnd = loadSound("sounds/sounds_bird_select.mp3");
    snortsnd = loadSound("sounds/sounds_pig_snort.mp3");
}
